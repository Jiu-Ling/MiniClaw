#!/usr/bin/env python3
"""
Skill Packager - Creates a distributable .skill file of a MiniClaw skill folder

Usage:
    python package_skill.py <path/to/skill-folder> [output-directory]

Example:
    python package_skill.py .miniclaw/skills/my-skill
    python package_skill.py .miniclaw/skills/my-skill ./dist
"""

#!/usr/bin/env python3
"""
Minimal validator for MiniClaw skill folders.
"""
...
def validate_skill(skill_path):
    ...
    always_active = frontmatter.get("always_active")
    if always_active is not None and not isinstance(always_active, (bool, str)):
        return False, f"'always_active' must be a boolean or string, got {type(always_active).__name__}"
